...
set dst "/home/francois/Documents" # Variable qui contient le chemin du dossier de destination où les sauvegardes seront stockées
...
set diff_arch "$src/development.diff.tar.zst"
...
info "Verification de l'existence de l'archive complete"
if test -f "$full_arch"
