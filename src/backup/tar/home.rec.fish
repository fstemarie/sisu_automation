...
set dst "home/francois/home."(date +%s) # Variable qui contient le chemin vers le dossier de destination
set full_arch "$src/home.full.tar.zst" # Variable qui contient le chemin vers l'archive de sauvegarde la plus récente
set diff_arch "$src/home.diff.tar.zst" # Variable qui contient le chemin vers l'archive de sauvegarde différentielle la plus récente
